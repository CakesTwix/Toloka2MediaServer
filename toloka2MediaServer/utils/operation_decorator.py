...
def operation_tracker(operation_type):
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if not hasattr(config, 'operation_result') or config.operation_result is None:
            ...
            config.operation_result.response_code = ResponseCode.PARTIAL  # Assume partial unless completed
